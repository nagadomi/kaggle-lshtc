...
vt_knn: vt_knn.cpp reader.hpp tick.hpp util.hpp inverted_index.hpp tfidf_transformer.hpp SETTINGS.h

vt_ncc: vt_ncc.cpp reader.hpp tick.hpp util.hpp inverted_index.hpp tfidf_transformer.hpp nearest_centroid_classifier.hpp SETTINGS.h
